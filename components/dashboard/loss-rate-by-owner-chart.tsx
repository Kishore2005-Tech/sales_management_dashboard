...
interface LossRateByOwnerChartProps {
...
export function LossRateByOwnerChart({ data }: LossRateByOwnerChartProps) {
  ...
  return (
    <Card className="border-border bg-card">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium">Loss % by Salesperson</CardTitle>
      </CardHeader>
