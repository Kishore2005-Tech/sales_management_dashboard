...
interface LossRateBySourceChartProps {
...
export function LossRateBySourceChart({ data }: LossRateBySourceChartProps) {
  ...
  return (
    <Card className="border-border bg-card">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium">Loss % by Source</CardTitle>
      </CardHeader>
