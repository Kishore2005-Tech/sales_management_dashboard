...
interface LostReasonsByOwnerChartProps {
...
export function LostReasonsByOwnerChart({ data }: LostReasonsByOwnerChartProps) {
  ...
  return (
    <Card className="border-border bg-card">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium">Lost Reasons by Salesperson</CardTitle>
      </CardHeader>
