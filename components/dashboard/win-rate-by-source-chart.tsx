...
interface WinRateBySourceChartProps {
...
export function WinRateBySourceChart({ data }: WinRateBySourceChartProps) {
  ...
  return (
    <Card className="border-border bg-card">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium">Win % by Source</CardTitle>
      </CardHeader>
