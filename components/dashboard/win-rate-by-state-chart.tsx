...
interface WinRateByStateChartProps {
...
export function WinRateByStateChart({ data }: WinRateByStateChartProps) {
  ...
  return (
    <Card className="border-border bg-card">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium">Win % by State</CardTitle>
      </CardHeader>
